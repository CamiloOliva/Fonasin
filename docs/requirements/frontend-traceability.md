...
| FE-EXT-004A | Solicitud de ahorro voluntario | EXT | En curso | El acceso publico lleva al login y abre una pantalla privada independiente de afiliacion. El asociado registra en pesos enteros un monto mensual limitado a $10.000.000.000 y confirma la solicitud; MariaDB conserva el tramite y administracion puede aprobar o rechazar con auditoria. Genera una libranza privada con aporte vigente, ahorro solicitado y total mensual; solo administracion puede verla o descargarla y ambas acciones se auditan. Falta aprobacion institucional del alcance. |
