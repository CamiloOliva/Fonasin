...
| FE-OBQ-003 | Estado de cuenta | OBQ | En curso | El portal presenta en una sola vista creditos, aportes, ahorro permanente y ahorro voluntario. El contrato consolidado `GET /portal/account-statement` y las importaciones XLSX siguen disponibles; falta validacion visual final con datos reales. |
