...
| FE-EXT-004 | Actualizacion de datos | EXT | En curso | El asociado crea o reutiliza un borrador temporal por 24 horas identificado como `data_update`. El flujo bloquea cambios de identidad y cargas documentales, genera solo el formulario actualizado, conserva soportes y libranza originales, y permite al backoffice aplicarlo sin una nueva libranza. Falta aprobacion visual final y definir retencion historica. |
