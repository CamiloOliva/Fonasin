...
export const convenios: Convenio[] = [
 ...
 {id:10,name:'Capillas de la Fe',category:'Funerarios',description:'Plan de previsión exequial con cobertura nacional, protección familiar y asistencia para mascotas.',logo:'/images/logo-placeholder.svg'},
