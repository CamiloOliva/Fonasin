...
El backend esta en construccion. Actualmente contiene las migraciones base y pruebas de contrato del esquema; todavia no expone autenticacion, portal privado ni funciones administrativas.
